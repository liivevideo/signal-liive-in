...
/***/ function(module, exports, __webpack_require__) {
	...
	var getUserMedia = (navigator.getUserMedia || navigator.mozGetUserMedia || navigator.webkitGetUserMedia || navigator.msGetUserMedia).bind(navigator);
	...
	var removedVideoChannel = function removedVideoChannel(id) {
	    console.log("REMOVING VIDEO CHANNEL VIEW");
	    var video = document.getElementById("remoteView" + id);
	    if (video) video.remove();
	};
	var addedVideoChannel = function addedVideoChannel(id, stream) {
	...
	var foundLocalVideoChannel = function foundLocalVideoChannel(stream) {
	...
	var Room = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  RTCChannel = __webpack_require__(55);
	
	  Handshake = __webpack_require__(56);
	  ...
	  Room = function () {
	    ...
	    exchangeDescription = function exchangeDescription(id, description) {
	    ...
	    exchangeCandidate = function exchangeCandidate(id, candidate) {
...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  RTCChannel = function () {
	    ...
	    createTextChannel = function createTextChannel(pc, socketId) {
	      var dataChannel;
	    ...
	    createOffer = function createOffer(pc, socketId) {
	    ...
	    _createListener = function _createListener(socketId, isOffer) {
	      var pc;
