#io = require('../../bower_components/socket.io')
# todo: inject socket.io rather than relying on global.
class Handshake
    socket = null
    ...
    constructor: (configuration, _reactions) ->
        ...
        socket = io(signalServer) # "https://50.67.201.214:4443")
    ...
    leave: (id, callback) -> # todo check this.
